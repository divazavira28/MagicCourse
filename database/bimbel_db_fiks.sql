...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2024 at 05:09 AM
...
INSERT INTO `xx_pendaftaran` (`id_pendaftaran`, `id_user`, `id_kelas`, `nomor_pendaftaran`, `status_pembayaran`, `status`, `admin_acc`, `bukti_pembayaran`, `created_at`, `id_profil`, `id_jenis_kelamin`) VALUES
(9, 6, 2, 'bcasg2024614338936800', 1, 1, 'Delia Dwi', '6bcasg2024614338936800.jpeg', '2024-05-20', 0, 0);
...
INSERT INTO `xx_profile` (`foto`, `nama`, `no_hp`, `tempat_lahir`, `tanggal_lahir`, `umur`, `asal_sekolah`, `jenis_kelamin`, `alamat`, `created_at`, `id_user`) VALUES
('1.jpeg', 'Yoga Anugrah Pratama.SY', '08981001119', 'Palembang', '2006-06-06', 14, 'SD', 'L', 'Jl. Ade Irma Nasution No.123, Sungai Pangeran, Kec. Ilir Tim. I, Kota Palembang, Sumatera Selatan 30127.', '2020-06-16', 1),
('', 'Delia Dwi Anjani', '083890549397', 'ciamis', '2011-01-04', 13, 'smp', 'P', 'depok', '2024-05-18', 2),
('5.png', 'miko', '8121345', 'depok', '2018-07-05', 5, 'smp', 'L', 'depok', '2024-05-20', 3),
('6.jpeg', 'ryan', '08128571', 'depok', '2015-07-09', 8, 'SMPN 14 DEPOK', 'L', 'depok', '2024-05-20', 4),
('7.jpeg', 'lilili', '0812345678', 'depok', '2016-05-11', 8, 'SMPN 15', 'P', 'Depok', '2024-05-20', 5);
...
(8, 'andi', 'andibae@gmail.com', '$2y$10$24BStkzD.p2TpksG7xZjCO1uS38X/hgCc1RwjXejXgFCvfyJxHAum', 'andibae', 1, '2024-05-23'),
(9, 'nadia', 'nadiaomara07@gmail.com', '$2y$10$2sO53enXrKon3vy8gdKvXe.d3UOF5ierkUcIz2vhcsPy7FzlKoskC', 'nadia omara', 1, '2024-05-23'),
(10, 'admin', 'Agum@gmail.com', '$2y$10$bDoa9Bp6EBxhZNvVUSdOPea8CP2OTd1fDQDo7DP2nAqOlB/4dCpGW', 'Agum', 1, '2024-05-24'),
(11, 'Wira', 'wira98@gmail.com', '$2y$10$HPU0r8AvF3kEhB7iiklucuOKX38o4vfiT.Tezdr8cf/YnRkuagRhy', 'WIRA SUKMA  SAPUTRA', 1, '2024-05-24');
