...
<head>
	<title>Login Magic Course</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<!--===============================================================================================-->
	<link rel="icon" type="image/png" href="<?= base_url(); ?>assets/AdminBsb/login/images/logo_tab.png" />
	<!--===============================================================================================-->
...
<body>
	...
	<?php if ($this->session->flashdata('message')) : ?>
		<script type="text/javascript">
			...
			<?php $this->session->unset_tempdata('message'); ?>
		</script>
	<?php endif; ?>
	<?php if ($this->session->flashdata('abort')) : ?>
		<script type="text/javascript">
			...
			<?php $this->session->unset_tempdata('abort'); ?>
		</script>
	<?php endif; ?>
	...
	<div class="limiter">
		<div class="container-login100" style="background:linear-gradient(to right, rgba(2,0,36,1) 0%, rgba(45,45,148,1) 35%, rgba(0,212,255,1) 100%) !important;">
			<div class="wrap-login100">
				...
				<span class="login100-form-title p-b-20" style="color: rgba(45,45,148,1)!important;">
					Magic Course Admin
				</span>
				<span class="login100-form-title p-b-20">
					<img src="<?= base_url(); ?>assets/AdminBsb/login/images/logo_admin.png" alt="">
				</span>
