            					...
            					<div class="body">
            						...
            						<div class="row clearfix">
            							...
            							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            								<div class="form-group">
            									<div class="form-line">
            										<input type="text" class="form-control" value="<?= $kelas['jadwal_kelas'] ?>" name="jadwal_kelas" required autocomplete="off" />
            									</div>
            								</div>
            							</div>
            						</div>
            						...
            						<div class="row clearfix">
            							<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            								<h4 style="font-size: 17.1px;">Paket</h4>
            							</div>
            							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            								<div class="form-group">
            									<div class="form-line">
            										<input type="text" class="form-control" value="<?= $kelas['judul_kelas'] ?>" name="judul_kelas" required autocomplete="off" />
            									</div>
            								</div>
            							</div>
            						</div>
            						<div class="row clearfix">
            							...
            							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            								<div class="form-group">
            									<div class="form-line">
            										<input type="text" value="<?= $kelas['biaya_pendaftaran'] ?>" class="form-control"  name="biaya_pendaftaran" required autocomplete="off" />
            									</div>
            								</div>
            							</div>
            						</div>
            						...
            						<div class="row clearfix">
            							...
            							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            								<div class="form-group">
            									<div class="form-line">
            										<input type="text" class="form-control" value="<?= $kelas['harga_kelas'] ?>" name="harga_kelas" required autocomplete="off" />
            									</div>
            								</div>
            							</div>
            						</div>
            						...
            						<div class="row clearfix">
            							...
            							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            								<div class="form-group">
            									<div class="form-line">
            										<input type="text" class="form-control"  name="waktu_kelas" required autocomplete="off" value="<?= $kelas['waktu_kelas'] ?>" />
            									</div>
            								</div>
            							</div>
            						</div>
