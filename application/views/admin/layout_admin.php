...
<head>
	...
	<?php if ($this->uri->segment(3) == 'laporan') : ?>
		<title>Laporan Pendaftaran Magic Course</title>
	<?php else : ?>
		<title>Welcome To | Magic Course Admin</title>

	<?php endif; ?>
	<!-- Favicon-->
	<link rel="icon" href="<?= base_url(); ?>assets/Logo/logo_tab.png" type="image/x-icon">
