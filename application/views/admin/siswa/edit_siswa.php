				...
				<div class="card">
					<div class="header">
						<h2 style="font-weight: bold;color: #ad1455;font-size: 22px;">
							<center>FORM EDIT ADMIN MAGIC COURSE</center>
							<br>
						</h2>
					</div>
					...
					<div class="body">
						...
						<div class="row clearfix">
							<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
								<h4 style="font-size: 17.1px;">Asal Sekolah Menengah</h4>
							</div>
							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
								<div class="form-group">
									<div class="form-line">
										<input type="text" value="<?= $detail['asal_sekolah'] ?>" class="form-control" placeholder="Ex: blablacrocxxx" name="asal_sekolah" required autocomplete="off" />
									</div>
								</div>
							</div>
						</div>
