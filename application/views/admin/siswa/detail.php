    				...
    				<div class="card">
    					...
    					<div class="body">
    						...
    						<?php if (isset($detail)) : ?>
    							...
    							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    								<div class="col-xs-5 col-sm-5 col-md-2 col-lg-2">
    									<label style="font-size: 18px;font-weight: normal; padding-left: 0px;">Asal Sekolah Menengah</label>
    								</div>
    								<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
    									<label class="pull-right" style="font-size: 18px;font-weight: normal; padding-left: 0px;">:</label>
    								</div>
    								<div class="col-xs-5 col-sm-5 col-md-9 col-lg-9">
    									<label style="font-size: 18px;font-weight: normal;padding-left: 0px;"><?= $detail['asal_sekolah'] ?></label>
    								</div>
    							</div>
