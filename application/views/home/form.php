 		...
 		<div class="row d-flex mb-5 contact-info">
 			<div class="col-md-4">
 				<div class="bg-light align-self-stretch box p-4 text-center">
 					...
 					<p style="color: red;">Pembayaran sebesar Rp. 1.650.000,00/Bulan. <br>
 					<p style="color: red;">Pembayaran sebesar Rp. 2.450.000,00/Bulan. <br>
 					<p>

 						Rincian : Administrasi Rp. 150.000,00 <br>

 						Nomor rekening : 7151511051 (BCA) a.n/ Magic Course</p>
 				</div>
 			</div>
 								...
 								<div class="form-line">
 									<select name="kelas" id="asd" class="form-control">
 										...
 										<?php foreach ($kelas as $kel) : ?>
 											<option value="<?= $kel['id_kelas'] ?>" <?= ($this->session->userdata('selected_kelas') == $kel['id_kelas']) ? 'selected' : '' ?>><?= $kel['judul_kelas'] ?></option>
 										<?php endforeach; ?>
 									</select>
 								</div>
 							</div>
